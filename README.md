...
```yml
production:
	AGENTS_ADDRESS: https://agents.strahovkaru.ru
	NODE_ADDRESS: api.strahovkaru.ru:9000
	...
```
...
### Usage in frontend
- Directly: `SystemTag.node_address // => api.strahovkaru.ru:9000`
- Using function `tag()`:`SystemTag.tag('node_address') // => api.strahovkaru.ru:9000`
